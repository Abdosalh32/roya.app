...
class AppTranslations extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
    'ar': {
      ...
      'dialog_reject_body': 'يرجى كتابة سبب رفض الطلب',
      'rejection_reason_hint': 'مثال: المنتج غير متوفر حالياً',
    ...
    'en': {
      ...
      'dialog_reject_body': 'Please provide a reason for rejecting this order',
      'rejection_reason_hint': 'e.g., Product is currently unavailable',
